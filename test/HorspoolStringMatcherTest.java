...
class HorspoolStringMatcherTest {
    ...
    @Test
    void computesCorrectShiftTable2() {
        HorspoolStringMatcher matcher = new HorspoolStringMatcher("gooddog");
        assertEquals(1, matcher.getShift('o'));
        assertEquals(2, matcher.getShift('d'));
